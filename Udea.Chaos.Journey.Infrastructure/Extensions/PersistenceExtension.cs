...
using Udea.Chaos.Journey.Infrastructure.Adapters;
using Udea.Chaos.Journey.Infrastructure.Serialization;

namespace Udea.Chaos.Journey.Infrastructure.Extensions
{
    public static class PersistenceExtensions
    {
        ...
        public static IServiceCollection AddPersistence(this IServiceCollection svc, IConfiguration config)
        {
            ...
            svc.AddTransient<IJourneyRepository, JourneyRepository>();
